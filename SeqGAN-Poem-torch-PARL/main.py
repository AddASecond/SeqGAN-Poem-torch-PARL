...
# PARL-related RL agent
from model import GeneratorAsRLModel
...
parser.add_argument('--g_pretrain_steps', type=int, default=500, metavar='N',
...
parser.add_argument('--vocab_size', type=int, default=6915, metavar='N',
                    help='vocabulary size (default: 10)')
parser.add_argument('--batch_size', type=int, default=64, metavar='N',
                    help='batch size (default: 64)')
parser.add_argument('--n_samples', type=int, default=1600, metavar='N',
                    help='number of samples gerenated per time (default: 6400)')
parser.add_argument('--gen_lr', type=float, default=1e-2, metavar='LR',
                    help='learning rate of generator optimizer (default: 1e-3)')
parser.add_argument('--dis_lr', type=float, default=1e-4, metavar='LR',
...
if __name__ == '__main__':
    ...
    ### using PARL to initialize ###
    RlModel = GeneratorAsRLModel(args.vocab_size, g_embed_dim, g_hidden_dim, args.cuda)
    RlAlgorithm = PolicyGradient(RlModel, lr=args.gen_lr)
    RlAgent = Agent(RlAlgorithm, args.batch_size, g_seq_len)



    generator = RlModel.generator
